...
from h_gar.workspace.base_workspace import BaseWorkspace
from h_gar.policy.h_gar_policy import (
    HGarPolicy,
)
from h_gar.dataset.base_dataset import BaseImageDataset
from h_gar.dataset.umi_multi_dataset import UmiMultiDataset
from h_gar.common.checkpoint_util import TopKCheckpointManager
from h_gar.common.pytorch_util import dict_apply
from h_gar.model.autoregressive.ema_model import EMAModel
from h_gar.model.common.lr_scheduler import get_scheduler
from h_gar.utils.load_env import load_env_runner, env_rollout
from h_gar.eval.eval import test_video_fvd, test_action_l2
from h_gar.utils.data_utils import resize_image

OmegaConf.register_new_resolver("eval", eval, replace=True)


class TrainHGarWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: HGarPolicy = hydra.utils.instantiate(
            cfg.model.policy,
        ...
        self.ema_model: HGarPolicy = None
